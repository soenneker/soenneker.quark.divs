# Contributing to Soenneker.Quark.Divs
...
1. **Create an Issue**
   - If you have a new feature idea, a bug report, or any other improvement suggestion, start by creating an issue on the [Issues](https://github.com/soenneker/soenneker.quark.divs/issues) page.
...
1. **Create a Pull Request**
   - Go to the [Pull Requests](https://github.com/soenneker/soenneker.quark.divs/pulls) page of the original repository.
